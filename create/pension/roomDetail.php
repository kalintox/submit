...
<body>
    ...
    <div id="contents">
        <!-- メイン 開始 -->
        <?php
        $sql = "SELECT room_name, information, main_image, image1, image2, image3, type_name, dayfee, amenity FROM room, room_type WHERE room.type_id = room_type.type_id AND room.room_no = {$rno}";
                ...
                <section>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="number"><?php echo number_format($row['dayfee']); ?></td>
